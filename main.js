...
function tcDraw(){
  ...
  TC_NODES.forEach(node=>{
    ...
    else if(canDo){bgF=dom.bg;bC=isA||isD?dom.textDark:dom.textDark+'aa';bW=isA||isD?2:1.5;tC='#000';}
    else{bgF=dom.bg+'99';bC=isA||isD?dom.textDark:'rgba(140,140,140,0.5)';bW=isA||isD?2:1;tC='#000';}
